...
export const menuInvesterItems =[
       ...
       new Menu (51, 'Manage Profile', null, null, 'person_pin', null, true, 0),
       new Menu (53, 'Profile Details', '/admin/investor/basicdetails', null, 'arrow_right', null, false, 51),
       new Menu (54, 'Bank Account Details', '/admin/investor/bankdetails', null, 'arrow_right', null, false, 51),
       new Menu (55, 'Trusted Contact Person', '/admin/investor/trustedcontact', null, 'arrow_right', null, false, 51),
       new Menu (57, 'Suitability Questions', '/admin/investor/questionnaire', null, 'arrow_right', null, false, 51),
       new Menu (58, 'Investment Profile', '/admin/investor/investmentprofile', null, 'arrow_right', null, false, 51),
       new Menu (74, 'My Documents', '/admin/investor/mydocuments', null, 'arrow_right', null, false, 51),
       new Menu (70, 'Investment', null, null, 'money', null, true, 0),
       new Menu (72, 'My Investments', '/admin/investor/myinvestment', null, 'arrow_right', null, false, 70),
       new Menu (73, 'My Watchlist', '/admin/investor/mywatchlist', null, 'arrow_right', null, false, 70),
