...
@Component({
  ...
  templateUrl: './requestoffering.component.html',
  styleUrls: ['./requestoffering.component.css'],
  providers: [DecimalPipe],
})
export class RequestofferingComponent implements OnInit {
